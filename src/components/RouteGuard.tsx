...
const PUBLIC_PAGE_PATHS = ['/pages/login/index', '/pages/home/index', '/pages/projects/index', '/pages/contact/index', '/pages/nature-class/index', '/pages/family-sports/index']
